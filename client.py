...
def recieveMsg():
    ...
    while True:
        ...
        if('player_type'in message):
            recieveMsg=eval(message)
            playerType=recieveMsg['player_type']
            playerTurn=recieveMsg['player_turn']
...
def finishingBox():
    ...
    finishingBox = Label(gameWindow, text="Home", font=("Chalkboard SE", 32), width=7, height=4, borderwidth=0, bg="green", fg="white")
    finishingBox.place(x=screen_width/2 - 78, y=screen_height/2 -160)
